                    ...
                    <div class="flex justify-center">
                            <div class="px-4 sm:px-8 max-w-5xl m-auto">
                                ...
                                <ul class="border border-gray-200 rounded overflow-hidden shadow-md">
                                    ...
                                    <li class="px-4 py-2 bg-white hover:bg-sky-100 hover:text-sky-900 border-b last:border-none border-gray-200 transition-all duration-300 ease-in-out">"KOL<span class="bg-green-600 p-2 text-white">Y</span>E" yazarsanız "Y" harfi doğru yerde olacağı için yeşil yanar</li>
                                    <li class="px-4 py-2 bg-white hover:bg-sky-100 hover:text-sky-900 border-b last:border-none border-gray-200 transition-all duration-300 ease-in-out">"<span class="bg-yellow-400 p-2 text-white">A</span>RMUT" yazarsanız "A" harfi yanlış yerde olduğu için sarı yanar.</li>
